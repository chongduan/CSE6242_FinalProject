...
In this project, I will explore a dataset that contains information about movies, including ratings, budget, gross revenue and other attributes. It was prepared by Dr. Guy Lebanon, and here is his description of the dataset:
...
ggplot(data = temp, aes(x=variable, y = Runtime, group = variable)) + 
  geom_boxplot(na.rm = TRUE) + 
  ylim(-10, 250) +
  theme(axis.text.x=element_text(angle = 90, vjust=0.5, hjust=1))  +
